<div style="font-family: Arial, sans-serif; background: linear-gradient(to bottom right, #fff7ed, #fff1e0, #fff3e0); padding: 40px; border-radius: 25px; text-align: center; color: #333;">
    ...
    <h2 style="font-size:28px; color:#d97706; margin-bottom:10px;">¡Queda 1 hora para tu cita!</h2>
    <p style="font-size:16px; margin-bottom:20px;">Hola {{ $user->name }}, tu cita está programada para hoy:</p>
